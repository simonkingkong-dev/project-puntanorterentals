    ...
    <div className="min-h-[70vh] bg-gradient-to-b from-muted/50 to-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        <article className="rounded-2xl border bg-card/80 backdrop-blur-sm shadow-sm p-8 sm:p-10">
          ...
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">{m.page_about_lead}</p>
          <p className="mt-6 text-muted-foreground leading-relaxed">{m.page_about_body}</p>
          <div className="mt-10">
            <Button
              asChild
