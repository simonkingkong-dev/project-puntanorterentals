...
import { handleDeleteTestimonial } from "./actions"; // Importamos la Server Action
...
export default function DeleteTestimonialButton({ testimonialId }: DeleteTestimonialButtonProps) {
  ...
  const onDeleteConfirm = () => {
    startTransition(async () => {
      ...
      if (result.success) {
        toast.success("Testimonio borrado exitosamente.");
      } else {
        toast.error(result.error || "Error al borrar el testimonio.");
      }
      setIsOpen(false);
    });
  };
