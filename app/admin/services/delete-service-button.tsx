...
import { handleDeleteService } from "./actions"; // Importamos la Server Action
  ...
  const onDeleteConfirm = () => {
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        toast.error(result.error || "Error al borrar el servicio.");
      }
      setIsOpen(false);
    });
  };
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Esta acción no se puede deshacer. Esto borrará permanentemente el servicio
            de la base de datos.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
